  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === "sign-up") {
        ...
        void log({
          data: { provider: "email", email, success: true, reason: "signup_email_sent" },
        });
      } else {
      ...
      if (challenge.trim().toUpperCase() !== expected) {
        ...
        void log({
          data: {
            ...
            email: user.email,
            success: false,
            reason: "verify_challenge_failed",
          },
        });
        if (nextAttempts >= MAX_CONFIRM_ATTEMPTS) {
          ...
          void log({
            data: {
              ...
              email: user.email,
              success: false,
              reason: "auto_signout_max_attempts",
            },
          });
          await onCancel();
          setBusy(null);
        ...
        >
            ...
            {noEmail ? (
              <>
                ...
                <div className="text-xs text-silver-dim mt-2 leading-relaxed">
                  ...
                  Confirm the verification code below to continue, or sign out and try a different
                  provider.
                </div>
          ...
          {noEmail && (
            <div className="mb-6">
              ...
              >
                ...
                <span className="text-ember tracking-[0.4em]" aria-hidden="true">
                  {expected}
                </span>
              </label>
              <input
              ...
              <div
                id="verify-attempts"
                aria-live="polite"
                className="font-mono text-[10px] uppercase tracking-widest text-breach mt-2 h-4"
              >
                {autoSignedOut
          ...
          {!noEmail && (
            <p className="text-sm text-silver-dim leading-relaxed mb-8">
              For your safety we ask you to confirm before granting access to the protocol. If this
              isn&apos;t you, cancel and try again.
            </p>
          )}
...
function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true">
      <path
        fill="#FFC107"
        d="M43.6 20.5h-1.9V20H24v8h11.3c-1.6 4.7-6.1 8-11.3 8-6.6 0-12-5.4-12-12s5.4-12 12-12c3 0 5.8 1.1 7.9 3l5.7-5.7C34 6.1 29.3 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.2-.1-2.3-.4-3.5z"
      />
      <path
        fill="#FF3D00"
        d="M6.3 14.7l6.6 4.8C14.7 16 19 13 24 13c3 0 5.8 1.1 7.9 3l5.7-5.7C34 6.1 29.3 4 24 4 16.1 4 9.3 8.5 6.3 14.7z"
      />
      <path
        fill="#4CAF50"
        d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2c-2 1.5-4.5 2.4-7.2 2.4-5.2 0-9.6-3.3-11.3-8l-6.5 5C9.2 39.4 16 44 24 44z"
      />
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.3-4.1 5.7l6.2 5.2C41 35.2 44 30 44 24c0-1.2-.1-2.3-.4-3.5z"
      />
    </svg>
  );
}
