      ...
      <main>
        <header className="pt-40 pb-20 px-6 max-w-6xl mx-auto animate-entrance">
          ...
          <p className="max-w-2xl text-lg text-silver-dim leading-relaxed">
            Stack&apos;d is a private protocol for reclaiming the room. Phones go down, the deep
            work session begins, and a shared timer becomes the only thing on screen — until even
            that fades. What follows is what we built it on.
          </p>
        </header>
        ...
        <section className="py-24 px-6 max-w-5xl mx-auto">
          ...
          <ol className="space-y-6">
            {TENETS.map((t, i) => (
              <li
                key={t}
                className="grid grid-cols-[auto_1fr] gap-8 items-baseline border-b border-white/5 pb-6"
              >
