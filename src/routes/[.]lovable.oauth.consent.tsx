  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-6">
      <div className="max-w-md w-full border border-border rounded-xl p-8 space-y-5 bg-card">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Connect {clientName} to Stack'd</h1>
          <p className="text-sm opacity-75 mt-2">
            This lets {clientName} use Stack'd as you — reading your profile, focus history, groups,
            and rooms under the same permissions you have in the app.
          </p>
        </div>
