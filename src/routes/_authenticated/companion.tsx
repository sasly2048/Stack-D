  ...
  head: () => ({
    meta: [
      { title: "Study Companion — Stack'd" },
      {
        name: "description",
        content:
          "A private, always-on focus coach trained on your own Stack'd protocol, sessions and streak history.",
      },
  ...
  return (
    <div className="min-h-screen bg-obsidian text-silver flex flex-col">
      ...
      <div className="pt-24 flex-1 max-w-3xl w-full mx-auto px-6 pb-6 flex flex-col">
        ...
        <div
          ref={scrollRef}
          className="flex-1 overflow-y-auto glass rounded-xl p-5 space-y-4 min-h-[50vh]"
        >
          {messages.length === 0 && (
