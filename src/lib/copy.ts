...
export const copy = {
  ...
  realtime: {
    ...
    groupSprint: (name: string, group: string) =>
      `${name} opened a ${group} sprint — join if you're ready.`,
  },
  room: {
...
export const NARRATIVE_CHAPTERS: NarrativeChapter[] = [
  {
    key: "arrival",
    title: "The Arrival",
    subtitle: "You showed up. That was the hard part.",
    minXp: 0,
  },
  {
    key: "kindling",
    title: "The Kindling",
    subtitle: "A first small fire — held long enough to warm.",
    minXp: 150,
  },
  {
    key: "cadence",
    title: "The Cadence",
    subtitle: "You've found a rhythm. It's yours now.",
    minXp: 600,
  },
  {
    key: "keeper",
    title: "The Keeper",
    subtitle: "You keep the silence. Others feel it.",
    minXp: 1500,
  },
  {
    key: "steward",
    title: "The Steward",
    subtitle: "You hold space for the room, not just yourself.",
    minXp: 3500,
  },
  {
    key: "elder",
    title: "The Elder",
    subtitle: "You are what a full attention looks like.",
    minXp: 7500,
  },
];
