...
const sheetVariants = cva(
  "fixed z-[var(--z-dialog)] gap-5 overflow-y-auto bg-background p-5 shadow-[var(--shadow-overlay)] transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out sm:p-6",
  {
    variants: {
      side: {
